...
require __DIR__ . '/include/databases.inc.php';
...
if (empty($db)) {
    ...
    if ('show_mysql_state' != $action && 'show_mysql_vars' != $action && 'show_mysql_process' != $action) {
    ...
    require __DIR__ . '/include/tables.inc.php';
