...
function nav_bar($diff = '')
{
    ...
    if ('do_query' == $action || 'dump' == $action || 'desc' == $action) {
        $action_collapse = '';
    } else {
        $action_collapse = $action;
    }

    if (0 == $colors['tpl_type'] || 'no' == $collapse_right) {
        ### Right nav Bar
        ...
        $ico_mimine = '<a href="javascript:alt(\'mimineshow\',\'mimine\');" onMouseOver="over(\'manuel\', \''
                           . $diff
                           . '\')" onMouseOut="out(\'manuel\', \''
                           . $diff
                           . '\')"><img src="'
                           . $img_path
                           . 'img/manuel_off.gif" name="manuel'
                           . $diff
                           . '" border="0" '
                           . link_status($txt['manual_request'])
                           . '></a>&nbsp;';

        $ico_create_db = '<a href="javascript:alt(\'main.php?action=create_db\',\'create_db\');" onMouseOver="over(\'db\', \''
                           . $diff
                           . '\')" onMouseOut="out(\'db\', \''
                           . $diff
                           . '\')"><img src="'
                           . $img_path
                           . 'img/db_off.gif" name="db'
                           . $diff
                           . '" border="0" '
                           . link_status($txt['create_db'])
                           . '></a>&nbsp;';

        $ico_delete_db = '<a href="javascript:alt(\'main.php?db='
                           . $db_menu
                           . '&action=drop_database\',\'drop_database\');" onMouseOver="over(\'deletedb\', \''
                           . $diff
                           . '\')" onMouseOut="out(\'deletedb\', \''
                           . $diff
                           . '\')"><img src="'
                           . $img_path
                           . 'img/deletedb_off.gif" name="deletedb'
                           . $diff
                           . '" border="0" '
                           . link_status($txt['delete_db'])
                           . '></a>&nbsp;';

        $ico_show = '<a href="javascript:alt(\'main.php?db='
                           . $db_menu
                           . '&tbl='
                           . $tbl_menu
                           . '&action=view\',\'view\');" onMouseOver="over(\'affich\', \''
                           . $diff
                           . '\')" onMouseOut="out(\'affich\', \''
                           . $diff
                           . '\')"><img src="'
                           . $img_path
                           . 'img/affich_off.gif" name="affich'
                           . $diff
                           . '" border="0" '
                           . link_status($txt['display_content'])
                           . '"></a>&nbsp;';

        $ico_select = '<a href="javascript:alt(\'main.php?db='
                           . $db_menu
                           . '&tbl='
                           . $tbl_menu
                           . '&action=build_select\',\'build_select\');" onMouseOver="over(\'select\', \''
                           . $diff
                           . '\')" onMouseOut="out(\'select\', \''
                           . $diff
                           . '\')"><img src="'
                           . $img_path
                           . 'img/select_off.gif" name="select'
                           . $diff
                           . '" border="0" '
                           . link_status($txt['select'])
                           . '></a>&nbsp;';

        $ico_insert_into = '<a href="javascript:alt(\'main.php?db='
                           . $db_menu
                           . '&tbl='
                           . $tbl_menu
                           . '&action=insert\',\'insert\');" onMouseOver="over(\'nouv_enr\', \''
                           . $diff
                           . '\')" onMouseOut="out(\'nouv_enr\', \''
                           . $diff
                           . '\')"><img src="'
                           . $img_path
                           . 'img/nouv_enr_off.gif" name="nouv_enr'
                           . $diff
                           . '" border="0" '
                           . link_status($txt['add_record'])
                           . '></a>&nbsp;';

        ### Comment a table / MySQL >= 3.23.00

        if ($main_DB->Infos['Version'] >= 32300) {
            $ico_comment = '<a href="javascript:alt(\'main.php?db='
                           . $db_menu
                           . '&tbl='
                           . $tbl_menu
                           . '&action=comment\',\'comment\');" onMouseOver="over(\'comment\', \''
                           . $diff
                           . '\')" onMouseOut="out(\'comment\', \''
                           . $diff
                           . '\')"><img src="'
                           . $img_path
                           . 'img/comment_off.gif" name="comment'
                           . $diff
                           . '" border="0" '
                           . link_status($txt['add_comment'])
                           . '></a>&nbsp;';
        } else {
            $ico_comment = '';
        }

        $ico_create_tbl = '<a href="javascript:alt(\'main.php?db='
                           . $db_menu
                           . '&action=create_new_table\',\'create_new_table\');" onMouseOver="over(\'table\', \''
                           . $diff
                           . '\')" onMouseOut="out(\'table\', \''
                           . $diff
                           . '\')"><img src="'
                           . $img_path
                           . 'img/table_off.gif" name="table'
                           . $diff
                           . '" border="0" '
                           . link_status($txt['create_tbl'])
                           . '></a>&nbsp;';

        $ico_upload_dump = '<a href="javascript:alt(\'main.php?db='
                           . $db_menu
                           . '&tbl='
                           . $tbl_menu
                           . '&action=incoming_sql\',\'incoming_sql\');" onMouseOver="over(\'upload_dump\', \''
                           . $diff
                           . '\')" onMouseOut="out(\'upload_dump\', \''
                           . $diff
                           . '\')"><img src="'
                           . $img_path
                           . 'img/upload_dump_off.gif" name="upload_dump'
                           . $diff
                           . '" border="0" '
                           . link_status($txt['incoming_sql'])
                           . '></a>&nbsp;';

        $ico_add_field = '<a href="javascript:alt(\'main.php?db='
                           . $db_menu
                           . '&tbl='
                           . $tbl_menu
                           . '&action=add_field\',\'add_field\');" onMouseOver="over(\'ajout_champs\', \''
                           . $diff
                           . '\')" onMouseOut="out(\'ajout_champs\', \''
                           . $diff
                           . '\')"><img src="'
                           . $img_path
                           . 'img/ajout_champs_off.gif" name="ajout_champs'
                           . $diff
                           . '" border="0" '
                           . link_status($txt['add_field'])
                           . '></a>&nbsp;';

        ### Change type / MySQL >= 3.23.22

        if ($main_DB->Infos['Version'] >= 32322) {
            $ico_chg_type = '<a href="javascript:alt(\'main.php?db='
                            . $db_menu
                            . '&tbl='
                            . $tbl_menu
                            . '&action=change_type\',\'change_type\');" onMouseOver="over(\'change_type\', \''
                            . $diff
                            . '\')" onMouseOut="out(\'change_type\', \''
                            . $diff
                            . '\')"><img src="'
                            . $img_path
                            . 'img/change_type_off.gif" name="change_type'
                            . $diff
                            . '" border="0" '
                            . link_status($txt['change_type'])
                            . '></a>&nbsp;';
        } else {
            $ico_chg_type = '';
        }

        $ico_dump = '<a href="javascript:alt(\'main.php?db='
                          . $db_menu
                          . '&tbl='
                          . $tbl_menu
                          . '&action=dump\',\'dump\');" onMouseOver="over(\'dump\', \''
                          . $diff
                          . '\')" onMouseOut="out(\'dump\', \''
                          . $diff
                          . '\')"><img src="'
                          . $img_path
                          . 'img/dump_off.gif" name="dump'
                          . $diff
                          . '" border="0" '
                          . link_status($txt['dump_tbl'])
                          . '></a>&nbsp;';

        $ico_empty_tbl = '<a href="javascript:alt(\'main.php?db='
                          . $db_menu
                          . '&tbl='
                          . $tbl_menu
                          . '&action=empty\',\'empty\');" onMouseOver="over(\'empty\', \''
                          . $diff
                          . '\')" onMouseOut="out(\'empty\', \''
                          . $diff
                          . '\')"><img src="'
                          . $img_path
                          . 'img/empty_off.gif" name="empty'
                          . $diff
                          . '" border="0" '
                          . link_status($txt['emptyer_tbl'])
                          . '></a>&nbsp;';

        $ico_rename_tbl = '<a href="javascript:alt(\'main.php?db='
                          . $db_menu
                          . '&tbl='
                          . $tbl_menu
                          . '&action=rename\',\'rename\');" onMouseOver="over(\'renommer\', \''
                          . $diff
                          . '\')" onMouseOut="out(\'renommer\', \''
                          . $diff
                          . '\')"><img src="'
                          . $img_path
                          . 'img/renommer_off.gif" name="renommer'
                          . $diff
                          . '" border="0" '
                          . link_status($txt['rename_tbl'])
                          . '></a>&nbsp;';

        $ico_copy_tbl = '<a href="javascript:alt(\'main.php?db='
                          . $db_menu
                          . '&tbl='
                          . $tbl_menu
                          . '&action=copy\',\'copy\');" onMouseOver="over(\'copier\', \''
                          . $diff
                          . '\')" onMouseOut="out(\'copier\', \''
                          . $diff
                          . '\')"><img src="'
                          . $img_path
                          . 'img/copier_off.gif" name="copier'
                          . $diff
                          . '" border="0" '
                          . link_status($txt['copy_tbl'])
                          . '></a>&nbsp;';

        $ico_move_tbl = '<a href="javascript:alt(\'main.php?db='
                          . $db_menu
                          . '&tbl='
                          . $tbl_menu
                          . '&action=move\',\'move\');" onMouseOver="over(\'deplacer\', \''
                          . $diff
                          . '\')" onMouseOut="out(\'deplacer\', \''
                          . $diff
                          . '\')"><img src="'
                          . $img_path
                          . 'img/deplacer_off.gif" name="deplacer'
                          . $diff
                          . '" border="0" '
                          . link_status($txt['move_tbl'])
                          . '></a>&nbsp;';

        ### Order a table / MySQL >= 3.23.34

        if ($main_DB->Infos['Version'] >= 32334) {
            $ico_order_tbl = '<a href="javascript:alt(\'main.php?db='
                             . $db_menu
                             . '&tbl='
                             . $tbl_menu
                             . '&action=order\',\'order\');" onMouseOver="over(\'ordonner\', \''
                             . $diff
                             . '\')" onMouseOut="out(\'ordonner\', \''
                             . $diff
                             . '\')"><img src="'
                             . $img_path
                             . 'img/ordonner_off.gif" name="ordonner'
                             . $diff
                             . '" border="0" '
                             . link_status($txt['order_tbl'])
                             . '></a>&nbsp;';
        } else {
            $ico_order_tbl = '';
        }

        $ico_delete_tbl = '<a href="javascript:alt(\'main.php?db='
                            . $db_menu
                            . '&tbl='
                            . $tbl_menu
                            . '&action=delete_tbl\',\'delete_tbl\');" onMouseOver="over(\'del\', \''
                            . $diff
                            . '\')" onMouseOut="out(\'del\', \''
                            . $diff
                            . '\')"><img src="'
                            . $img_path
                            . 'img/del_off.gif" name="del'
                            . $diff
                            . '" border="0" '
                            . link_status($txt['delete_tbl'])
                            . '></a>&nbsp;';

        $ico_check_tbl = '<a href="javascript:alt(\'main.php?db='
                            . $db_menu
                            . '&tbl='
                            . $tbl_menu
                            . '&action=check\',\'check\');" onMouseOver="over(\'check\', \''
                            . $diff
                            . '\')" onMouseOut="out(\'check\', \''
                            . $diff
                            . '\')"><img src="'
                            . $img_path
                            . 'img/check_off.gif" name="check'
                            . $diff
                            . '" border="0" '
                            . link_status($txt['check_tbl'])
                            . '></a>&nbsp;';

        $ico_analyze_tbl = '<a href="javascript:alt(\'main.php?db='
                            . $db_menu
                            . '&tbl='
                            . $tbl_menu
                            . '&action=analyze\',\'analyze\');" onMouseOver="over(\'analyse\', \''
                            . $diff
                            . '\')" onMouseOut="out(\'analyse\', \''
                            . $diff
                            . '\')"><img src="'
                            . $img_path
                            . 'img/analyse_off.gif" name="analyse'
                            . $diff
                            . '" border="0" '
                            . link_status($txt['analyse_tbl'])
                            . '></a>&nbsp;';

        $ico_repair_tbl = '<a href="javascript:alt(\'main.php?db='
                            . $db_menu
                            . '&tbl='
                            . $tbl_menu
                            . '&action=repair\',\'repair\');" onMouseOver="over(\'reparer\', \''
                            . $diff
                            . '\')" onMouseOut="out(\'reparer\', \''
                            . $diff
                            . '\')"><img src="'
                            . $img_path
                            . 'img/reparer_off.gif" name="reparer'
                            . $diff
                            . '" border="0" '
                            . link_status($txt['repare_tbl'])
                            . '></a>&nbsp;';

        $ico_optimize_tbl = '<a href="javascript:alt(\'main.php?db='
                            . $db_menu
                            . '&tbl='
                            . $tbl_menu
                            . '&action=optimize\',\'optimize\');" onMouseOver="over(\'optimize\', \''
                            . $diff
                            . '\')" onMouseOut="out(\'optimize\', \''
                            . $diff
                            . '\')"><img src="'
                            . $img_path
                            . 'img/optimize_off.gif" name="optimize'
                            . $diff
                            . '" border="0" '
                            . link_status($txt['optimize_tbl'])
                            . '></a>&nbsp;';
